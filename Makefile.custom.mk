...
.PHONY: docker-build
docker-build: build-linux-amd64 ## Build a local dev image (TAG=cluster-manager:dev).
	docker build --build-arg TARGETOS=linux --build-arg TARGETARCH=amd64 -t $(or $(TAG),cluster-manager:dev) .
