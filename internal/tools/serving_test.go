...
func TestEnableModelServingOwnCluster(t *testing.T) {
	...
	assert.Equal(t, &SliceRelease{Name: "gazelle-agent-platform", Namespace: "org-giantswarm", ChartVersion: "4.27.2", Domain: "gazelle.example.io", ModelsHost: "models.gazelle.example.io"}, out.Slice)
